...
```console
cd ansible-role-automated-security-updates
pyenv virtualenv <python_version_to_use> ansible-role-automated-security-updates
pyenv local ansible-role-automated-security-updates
